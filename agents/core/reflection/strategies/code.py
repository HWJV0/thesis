...
class ReflexionCoTCodeStrategy(ReflexionCoTBaseStrategy):
    ...
    def generate_observation(
        ...
        if action_type.lower() == "finish":
            self._finished = True
            self._answer = query
            if qa_is_correct(execution_status, "Done", normalize=False):
        ...
        return qa_is_correct(execution_status, "Done", normalize=False), obs
    ...
    def halting_condition(self, idx: int, key: str, **kwargs: Any) -> bool:
        ...
        return qa_is_correct(execution_status, "Done", normalize=False) or idx >= max_trials
    ...
    def reflect_condition(
        ...
        return (
            idx > 0
            and not qa_is_correct(execution_status, "Done", normalize=False)
